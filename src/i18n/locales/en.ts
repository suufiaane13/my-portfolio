...
export const en: Translations = {
  ...
  nav: {
    ...
    gameHintMessages: [
      'Try a portfolio mini-game!',
      'Need a break? Play Memory or Chess 🎮',
      'Challenge: beat the chess bot!',
    ],
    gameHintCta: 'Play',
    gameHintBadge: 'Portfolio mini-games',
  ...
  chessGame: {
    title: 'Chess vs bot',
    description: 'Play chess against a bot. Pick your level and color.',
    backToPortfolio: 'Back to portfolio',
    setupTitle: 'New game',
    setupDescription: 'Choose difficulty, color, and board style.',
    setupMatch: 'Match',
    setupLook: 'Look',
    ...
    thinking: 'Stockfish is calculating…',
    check: 'Check!',
    youWin: 'Mate — you win!',
    youLose: 'Mate — bot wins',
    draw: 'Draw',
    resign: 'Resign',
    hint: 'Hint',
    newGame: 'New game',
    ...
    sidePanelTitle: 'Match',
    playingAs: 'Color',
    engineNote: 'Stockfish · openings · evaluation',
    engineFallback: 'Engine unavailable — random fallback move.',
    pieceSet: 'Piece set',
    boardTheme: 'Board',
    elo: 'Elo',
    preview: 'Preview',
    ...
    themeEmpty: 'No themes found',
    randomTheme: 'Random',
    prevMove: 'Previous move',
    nextMove: 'Next move',
    firstMove: 'Start of game',
    lastMove: 'End of game',
    reviewing: 'Review',
    analyzingMoves: 'Analyzing moves…',
    moves: 'Moves',
    ...
    leaderboard: {
      ...
      empty: 'No wins on this level yet — win to appear here!',
      emptyWinsOnly:
        'The leaderboard only lists wins. A loss or draw won’t show up here — have another go!',
      emptyAfterWin: 'Saving your win…',
      nameLabel: 'Your nickname',
      namePlaceholder: 'e.g. Soufiane',
      nameError: 'Invalid nickname (2–20 letters/numbers).',
      submit: 'Save game',
      success: 'Game saved!',
      successRank: 'Win saved — you are #{{rank}}!',
      submitError: 'Could not save. Try again.',
      rateLimit: 'Limit reached: 3 saves / hour. Try again in {{minutes}} min.',
  ...
  chatbot: {
    ...
    templates: {
      ...
      gameIntro:
        'The portfolio includes two mini-games: Memory (matching with a top-5 leaderboard) and Chess vs a Stockfish bot with openings and Expert difficulty. Pick one from the Games menu!',
  ...
  profile: {
    ...
    tagline:
      'Professional Bachelor’s degree in Computer Science from SUP MTI — web (HTML, CSS, PHP, JavaScript, React, Laravel) and software (Java, Kotlin).',
    availability: 'Open to opportunities — available for work',
    bio: [
      'Full-Stack developer with a Professional Bachelor’s degree in Computer Science from SUP MTI, I am looking for a role where I can apply my skills in web development (HTML, CSS, PHP, JavaScript, React, Laravel) and software (Java, Kotlin).',
  ...
  education: {
    ...
    items: {
      licence: {
        ...
        institution: 'SUP MTI School, Oujda',
      },
      tsdd: {
        year: '2023–2025',
  ...
  admin: {
    ...
    guide: {
      ...
      subtitle: 'TTS scripts, audio and manifest for the voice guide',
      ...
      topics: 'Topics',
      scriptEditor: 'TTS Script',
      scriptSaved: 'Script saved',
      scriptSaveError: 'Error saving script',
      audioManager: 'Audio',
      audioPlay: 'Play',
      audioPause: 'Pause',
      audioDelete: 'Delete audio',
      audioDeleteConfirm: 'Delete this audio file?',
      audioDeleteSuccess: 'Audio deleted',
      audioDeleteError: 'Error deleting audio',
      audioSize: 'Size',
      audioMissing: 'Audio not generated',
      audioPresent: 'Audio ready',
      audioRegenerating: 'Regenerating…',
      audioRegenerateSuccess: 'Audio regenerated',
      audioRegenerateError: 'Error regenerating audio',
      normalizedText: 'Normalized text (TTS)',
      saveScript: 'Save script',
      regenerateAudio: 'Regenerate audio',
      noScript: 'No script saved.',
      chunkIds: {
        'about-main': 'About',
        ...
        'cv-download': 'CV',
        'game-info': 'Games',
        'project-myfood': 'Project MyFood',
        'project-pure-power-menu': 'Project Pure Power Menu',
        'project-world-explorer': 'Project World Explorer',
        'project-sultan-kunafa': 'Project Sultan Kunafa',
      },
    },
    dashboard: {
      welcome: 'Dashboard',
    ...
    scores: {
      subtitle: 'Moderate the Memory leaderboard.',
    ...
    chess: {
      subtitle: 'Saved chess games and related stats.',
      empty: 'No games for these filters.',
      delete: 'Delete',
      ...
      stats: {
        ...
        last7d: 'Last 7 days',
        winRate: 'Win rate',
        winsByLevel: 'Wins by level',
        topOpening: 'Top opening',
