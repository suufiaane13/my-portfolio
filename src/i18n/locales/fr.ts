...
export const fr: Translations = {
  ...
  nav: {
    ...
    gameHintMessages: [
      'Essaie un mini-jeu du portfolio !',
      'Une pause ? Lance Mémoire ou Échecs 🎮',
      'Défi : bats le bot aux échecs !',
    ],
    gameHintCta: 'Jouer',
    gameHintBadge: 'Mini-jeux sur le portfolio',
  ...
  chessGame: {
    title: 'Échecs vs bot',
    description: 'Joue aux échecs contre un bot.',
    backToPortfolio: 'Retour au portfolio',
    setupTitle: 'Nouvelle partie',
    setupDescription: 'Choisis la difficulté, les pieces et le style du plateau.',
    setupMatch: 'Partie',
    setupLook: 'Apparence',
    ...
    myRealStyle: 'Mon vrai style',
    playWhite: 'Jouer les Blancs',
    playBlack: 'Jouer les Noirs',
    white: 'Blancs',
    black: 'Noirs',
    yourTurn: 'À toi de jouer',
    botTurn: 'Le bot réfléchit…',
    thinking: 'Stockfish calcule…',
    check: 'Échec !',
    youWin: 'Mat — tu gagnes !',
    youLose: 'Mat — le bot gagne',
    draw: 'Partie nulle',
    resign: 'Abandonner',
    hint: 'Indice',
    newGame: 'Nouvelle partie',
    playAgain: 'Rejouer',
    promote: 'Choisir la promotion',
    sidePanelTitle: 'Partie',
    playingAs: 'Couleur',
    engineNote: 'Stockfish · ouvertures · évaluation',
    engineFallback: 'Moteur indisponible — coup de secours aléatoire.',
    pieceSet: 'Set de pièces',
    boardTheme: 'Plateau',
    elo: 'Élo',
    preview: 'Aperçu',
    closePreview: 'Fermer',
    ...
    prevTheme: 'Thème précédent',
    nextTheme: 'Thème suivant',
    themeSearch: 'Rechercher un thème...',
    themeEmpty: 'Aucun thème trouvé',
    randomTheme: 'Aléatoire',
    prevMove: 'Coup précédent',
    nextMove: 'Coup suivant',
    firstMove: 'Début de partie',
    lastMove: 'Fin de partie',
    reviewing: 'Revue',
    analyzingMoves: 'Analyse des coups…',
    moves: 'Coups',
    ...
    leaderboard: {
      title: 'Classement (victoires)',
      loading: 'Chargement du classement…',
      empty: 'Aucune victoire pour ce niveau — gagne pour y figurer !',
      emptyWinsOnly:
        'Le classement ne compte que les victoires. Une défaite ou une nulle n’y apparaît pas — retente ta chance !',
      emptyAfterWin: 'Victoire en cours d’enregistrement…',
      ...
      success: 'Partie enregistrée !',
      successRank: 'Victoire enregistrée — vous êtes {{rank}}ᵉ !',
      submitError: 'Impossible d’enregistrer. Réessayez.',
      rateLimit:
        'Limite atteinte : 3 enregistrements max / heure. Nouvel envoi dans {{minutes}} min.',
  ...
  chatbot: {
    ...
    templates: {
      ...
      gameIntro:
        'Le portfolio propose deux mini-jeux : Mémoire (paires + classement top 5) et Échecs contre un bot Stockfish avec ouvertures et niveau Expert. Choisissez via le menu Jeux !',
      coreStack: 'Stack clé',
      location: 'Adresse',
      emailLabel: 'Email',
  ...
  profile: {
    ...
    tagline:
      'Titulaire d\'une Licence Professionnelle en Informatique à SUP MTI — développement web (HTML, CSS, PHP, JavaScript, React, Laravel) et logiciel (Java, Kotlin).',
    availability: 'À la recherche d’un poste — disponible pour missions',
    bio: [
      'Développeur Full-Stack, titulaire d\'une Licence Professionnelle en Informatique à SUP MTI, je suis à la recherche d’un poste me permettant de mettre en pratique mes compétences en développement web (HTML, CSS, PHP, JavaScript, React, Laravel) et logiciel (Java, Kotlin).',
  ...
  education: {
    ...
    items: {
      licence: {
        ...
        institution: 'École SUP MTI, Oujda',
      },
      tsdd: {
        year: '2023–2025',
  ...
  admin: {
    ...
    guide: {
      ...
      subtitle: 'Scripts TTS, audio et manifest du guide vocal',
      manifestInfo: 'Informations du manifest',
      ...
      topics: 'Topics',
      scriptEditor: 'Script TTS',
      scriptSaved: 'Script sauvegardé',
      scriptSaveError: 'Erreur lors de la sauvegarde',
      audioManager: 'Audio',
      audioPlay: 'Écouter',
      audioPause: 'Pause',
      audioDelete: 'Supprimer l\'audio',
      audioDeleteConfirm: 'Supprimer ce fichier audio ?',
      audioDeleteSuccess: 'Audio supprimé',
      audioDeleteError: 'Erreur lors de la suppression',
      audioSize: 'Taille',
      audioMissing: 'Audio non généré',
      audioPresent: 'Audio prêt',
      audioRegenerating: 'Régénération…',
      audioRegenerateSuccess: 'Audio régénéré',
      audioRegenerateError: 'Erreur lors de la régénération',
      normalizedText: 'Texte normalisé (TTS)',
      saveScript: 'Sauvegarder le script',
      regenerateAudio: 'Régénérer l\'audio',
      noScript: 'Aucun script enregistré.',
      chunkIds: {
        'about-main': 'À propos',
        'about-availability': 'Disponibilité',
        'skills-overview': 'Compétences',
        'experience-list': 'Expérience',
        'education-list': 'Formation',
        'contact-main': 'Contact',
        'cv-download': 'CV',
        'game-info': 'Jeux',
        'project-myfood': 'Projet MyFood',
        'project-pure-power-menu': 'Projet Pure Power Menu',
        'project-world-explorer': 'Projet World Explorer',
        'project-sultan-kunafa': 'Projet Sultan Kunafa',
      },
    },
    dashboard: {
    ...
    scores: {
      subtitle: 'Modération du classement Memory.',
    ...
    chess: {
      subtitle: 'Parties d’échecs enregistrées et stats associées.',
      empty: 'Aucune partie pour ces filtres.',
      delete: 'Supprimer',
      confirmDelete: 'Supprimer cette partie ?',
      deleteSuccess: 'Partie supprimée',
      deleteError: 'Impossible de supprimer la partie',
      noOpening: '—',
      ...
      stats: {
        ...
        winsByLevel: 'Victoires par niveau',
        topOpening: 'Ouverture fréquente',
        totalHints: 'Indices utilisés',
      },
      columns: {
        player: 'Joueur',
        difficulty: 'Niveau',
      ...
      detail: {
        ...
        pgn: 'Notation des coups',
        noMoves: 'Aucun coup enregistré',
        backToList: 'Retour aux parties',
        player: 'Joueur',
        opponent: 'Adversaire',
        result: 'Résultat',
        level: 'Niveau',
