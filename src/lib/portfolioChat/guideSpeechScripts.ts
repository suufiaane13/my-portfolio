...
const GUIDE_SPEECH_SCRIPTS: Record<Locale, Record<string, string>> = {
  fr: {
    ...
    'skills-overview':
      'Compétences. Stack clé : React, TypeScript, Laravel, Kotlin, Supabase et Docker. Frontend : HTML 5, CSS 3, JavaScript, TypeScript, React, Vite, Tailwind CSS et Bootstrap. Backend : PHP, Python, Laravel, FastAPI, Node JS, Express JS et API REST. Mobile et desktop : Kotlin, Jetpack Compose, React Native, Rust et Tauri. Data et DevOps : MySQL, MongoDB, Oracle, Supabase, Docker, Git et GitHub. Design : Figma, Canva, UI UX, responsive et PWA.',
    ...
    'cv-download':
      'CV. Mon CV est disponible au téléchargement depuis le portfolio.',
    ...
    'project-myfood':
      'MyFood. Application mobile Kotlin et Jetpack Compose, avec backend Supabase : authentification, PostgreSQL et stockage. Parcours complet client et espace de gestion pour restaurateurs. Technologies : Kotlin, Jetpack Compose, Supabase et Android.',

    'project-pure-power-menu':
      'Pure Power Menu. Carte digitale interactive pour Pure Power, avec fiches produits Mass Gainer et Shred, macros nutritionnels, QR code par table et design mobile first. Technologies : TypeScript, React, Tailwind CSS version 4 et Vite.',
  ...
  en: {
    ...
    'skills-overview':
      'Skills. Core stack: React, TypeScript, Laravel, Kotlin, Supabase, and Docker. Frontend: HTML 5, CSS 3, JavaScript, TypeScript, React, Veet, Tailwind CSS, and Bootstrap. Backend: PHP, Python, Laravel, FastAPI, Node JS, Express JS, and REST API. Mobile and desktop: Kotlin, Jetpack Compose, React Native, Rust, and Tauri. Data and DevOps: MySQL, MongoDB, Oracle, Supabase, Docker, Git and GitHub. Design: Figma, Canva, UI UX, responsive, and PWA.',
    ...
    'cv-download':
      'CV. My CV is available for download on the portfolio.',
    ...
    'project-myfood':
      'MyFood. Kotlin and Jetpack Compose mobile app with a Supabase backend: auth, PostgreSQL, and storage. Full customer journey and management space for restaurant owners. Technologies: Kotlin, Jetpack Compose, Supabase, and Android.',

    'project-pure-power-menu':
      'Pure Power Menu. Interactive digital menu for Pure Power with Mass Gainer and Shred product pages, nutritional macros, per table QR codes, and mobile first design. Technologies: TypeScript, React, Tailwind CSS version 4, and Veet.',
    ...
    'project-sultan-kunafa':
      'Sultan Kunafa. High-end landing page highlighting the visual experience around kunafa. Frontend optimized for conversion and WhatsApp ordering. Technologies: TypeScript, React, Tailwind CSS, and Veet.',
  },
}
